...
var renderMap = exports.renderMap = function renderMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFoZWVtLTI3MTkiLCJhIjoiY2xyOHY4anMwMHFmejJrbnhvMWJtd203ayJ9.G8b_b8iivYZLiFTfEaFNTg';
...
if (map_section) {
  var locations = JSON.parse(map_section.dataset.locations);
...
if (logOut_btn) logOut_btn.addEventListener('click', _login.logOut);
