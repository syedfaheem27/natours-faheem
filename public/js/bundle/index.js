...
/*eslint-disable*/ var _imagePreview = require("./imagePreview");
...
if (bookTourBtn) bookTourBtn.addEventListener("click", async (e)=>{
    ...
    await (0, _bookTour.bookTour)(tourId);
});

},{"./login":"7yHem","./signup":"fNY2o","./logout":"1ftRF","./mapbox":"3zDlz","./updateUserDetails":"aJWzA","./imagePreview":"eB6km","./bookTour":"7d23e"}],"7yHem":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5","./alert":"kxdiQ"}],"eB6km":[function(require,module,exports,__globalThis) {
/*eslint-disable*/ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "previewImage", ()=>previewImage);
const previewImage = (inputEl, previewSelector)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7d23e":[function(require,module,exports,__globalThis) {
/*eslint-disable*/ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const bookTour = async (tourId)=>{
    try {
        const stripe = await (0, _stripeJs.loadStripe)("pk_test_51QUsAqSDx1v8ADvKITuzM7klQ2RdGCUL5EVBWtbd5X0eYuKP53w7FyERfEGIHF4iYp7lkfHQ3alLaQFWKjypAe6u00f3dwHRJo");
        const res = await (0, _axiosDefault.default)(`/api/v1/bookings/checkout-session/${tourId}`);
        const session = res.data.data.session;
        if (res.data.status === "success") // location.replace(session.url);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@stripe/stripe-js":"8ZdZI"}],"8ZdZI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
